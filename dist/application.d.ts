...
declare const MiniprojectPortfolioApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class MiniprojectPortfolioApplication extends MiniprojectPortfolioApplication_base {
